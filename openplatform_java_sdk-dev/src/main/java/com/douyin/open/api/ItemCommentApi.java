...
public class ItemCommentApi {
     ...
     */
    public ItemCommentItemCommentInlineResponse200 itemCommentListGet(String openId, String accessToken, Integer count, String itemId, Integer cursor) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ItemCommentItemCommentInlineResponse200 itemCommentReplyListGet(String openId, String accessToken, Integer count, String itemId, String commentId, Integer cursor) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'openId' is set
        if (openId == null) {
