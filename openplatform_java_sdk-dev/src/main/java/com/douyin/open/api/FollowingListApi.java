...
public class FollowingListApi {
     ...
     */
    public UserFollowingFollowingInlineResponse200 followingListGet(String openId, String accessToken, Integer count, Integer cursor) throws RestClientException {
