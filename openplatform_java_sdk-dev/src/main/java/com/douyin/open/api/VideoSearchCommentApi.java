...
public class VideoSearchCommentApi {
     ...
     */
    public VideoSearchCommentVideoSearchCommentInlineResponse200 videoSearchCommentListGet(String accessToken, Integer count, String secItemId, Integer cursor) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public VideoSearchCommentVideoSearchCommentInlineResponse200 videoSearchCommentReplyListGet(String accessToken, Integer count, String secItemId, String commentId, Integer cursor) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'accessToken' is set
        if (accessToken == null) {
