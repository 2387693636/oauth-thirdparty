...
public class EnterpriseGrouponOrderRefundListApi {
     ...
     */
    public EnterpriseGrouponGrouponOrderOrderApplyRefundListInlineResponse200 enterpriseGrouponOrderRefundApplyListGet(String accessToken, String openId, Integer count, Integer startTime, Integer endTime, Integer cursor, Integer status) throws RestClientException {
