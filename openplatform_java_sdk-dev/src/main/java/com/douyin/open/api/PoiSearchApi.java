...
public class PoiSearchApi {
     ...
     */
    public VideoPoiVideoPoiInlineResponse200 poiSearchKeywordGet(String accessToken, Integer count, String keyword, Integer cursor, String city) throws RestClientException {
