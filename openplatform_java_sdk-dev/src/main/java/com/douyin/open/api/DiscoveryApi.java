...
public class DiscoveryApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public DiscoveryEntRankRankInlineResponse2001 discoveryEntRankVersionGet(String accessToken, Integer count, Integer type, Integer cursor) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'accessToken' is set
        if (accessToken == null) {
