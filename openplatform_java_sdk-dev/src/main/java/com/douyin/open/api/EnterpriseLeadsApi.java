...
public class EnterpriseLeadsApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public EnterpriseLeadsLeadsUserInlineResponse2003 enterpriseLeadsTagListGet(String openId, String accessToken, Integer count, Integer cursor) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public EnterpriseLeadsLeadsUserInlineResponse2004 enterpriseLeadsTagUserListGet(String openId, String accessToken, Integer count, Integer tagId, Integer cursor) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'openId' is set
        if (openId == null) {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public EnterpriseLeadsLeadsUserInlineResponse200 enterpriseLeadsUserListGet(String openId, String accessToken, Integer count, Integer startTime, Integer endTime, Integer actionType, Integer cursor, Integer leadsLevel) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'openId' is set
        if (openId == null) {
